...
class LLMClient:
    ...
    def generate_summary(self, transcript):
        ...
        prompt = f"""你是一位专业的会议纪要助手。请根据以下会议转写内容，生成按发言人分组的结构化摘要。

要求：
1. **按发言人分组**：将每个发言人的发言内容进行总结，列出每个发言人的核心观点和贡献
2. **关键点**：列出 3-5 个核心讨论要点，每个要点用一句话概括，并注明涉及的发言人
3. **待办事项**：列出需要后续跟进的任务，明确标注负责人
4. **结论**：总结会议达成的共识和决定
